...
namespace STR_CRL_API_COMALM.BL
{
    public class Sq_SolicitudRd
    {
        ...
        public ConsultationResponse<Moneda> ObtieneMonedas()
        {
            try
            {
                ...
                return Global.ReturnOk(monedas, "Consulta Exitosa");
            }
            catch (Exception ex)
            {
                return Global.ReturnError<Moneda>(ex);
            }
        }
